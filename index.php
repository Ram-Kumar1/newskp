      ...
      <nav class="navbar navbar-expand-lg navbar-light">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          ...
          <ul class="navbar-nav search-right mt-lg-0 mt-2">
            ...
            <li class="nav-item"><a href="contact.php" class="btn btn-primary d-none d-lg-block btn-style mr-2">Contact
                Us</a></li>
          </ul>
                    ...
                    <div class="price-inner card box-shadow">
                        ...
                        <div class="card-body">
                            ...
                            <div class="read-more mt-4 pt-lg-2">
                                <a href="contact.php" class="btn btn-style btn-outline-primary"> Go Basic</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="read-more mt-4 pt-lg-2">
                                <a href="contact.php" class="read-more">
                                    <a href="contact.php" class="btn btn-style btn-primary"> Go Standard</a>
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-6 price-main-info mt-lg-0 mt-4">
                    <div class="price-inner card box-shadow">
                        ...
                        <div class="card-body">
                            ...
                            <div class="read-more mt-4 pt-lg-2">
                                <a href="contact.php" class="btn btn-style btn-outline-primary"> Go Premium</a>
                            </div>
                        </div>
                    </div>
                </div>
  ...
  <div class="middle py-5">
    <div class="container py-xl-5 py-lg-3">
      <div class="welcome-left text-left py-3">
        ...
        <a href="contact.php" class="btn btn-white-active btn-primary mt-md-5 mt-4">Contact Us</a>
      </div>
    </div>
  </div>
  <!-- //middle -->
